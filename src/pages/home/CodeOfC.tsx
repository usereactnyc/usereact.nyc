        ...
        <Section id="coc">
          <TextGroup>
            ...
            <p>
              ...
              participants in any form. Meetup participants violating these
              rules may be sanctioned or expelled from the meetup at the
              discretion of the meetup organizers.
            </p>
            <p>
              If this is a paid event they may be expelled without a refund at
              the discretion of the meetup organizers. Harassment includes
              ...
              body size, race, religion, sexual images in public spaces,
            ...
            <p>
              Exhibitors and speakers at any useReactNYC event are also subject
              to the anti-harassment policy. In particular, exhibitors/speakers
            ...
            <p>
              ...
              (if applicable). In the event of serious infractions of the code
              of conduct, useReactNYC staff may share incident details and
              offenders’ names with third parties including but not limited to:
              venue staff, local law enforcement, and staff of other
              meetups/conferences. If you are being harassed, notice that
              someone else is being harassed, or have any other concerns, please
              contact a member of meetup staff immediately.
            </p>
            <p>
              ...
              experiencing harassment to feel safe for the duration of events.
