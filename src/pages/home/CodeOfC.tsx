    ...
    <Section>
      <TextGroup>
        ...
        <p>
          ...
          may be sanctioned or expelled from the meetup at the discretion of the
          meetup organizers.
        </p>
        <p>
        ...
        <p>
          ...
          the anti-harassment policy. In particular, exhibitors/speakers should
          not use sexualized images, activities, or other material. Staff
        ...
        <p>
          ...
          offender or expulsion from the event with no refund (if applicable).
          In the event of serious infractions of the code of conduct,
          useReactNYC staff may share incident details and offenders’ names with
          third parties including but not limited to: venue staff, local law
          enforcement, and staff of other meetups/conferences. If you are being
          harassed, notice that someone else is being harassed, or have any
          other concerns, please contact a member of meetup staff immediately.
        </p>
        <p>
          useReactNYC reserves the right to prohibit videotaping or photography
          for any meetup participant. Meetup staff will be happy to help
          participants contact venue security or local law enforcement, provide
          escorts, or otherwise assist those experiencing harassment to feel
          safe for the duration of events. We value your attendance.
        </p>
        <p>
